# Portions of this file are derived from the source below
...
RUN \
    ...
    cp -r /home/vmaf/model/* ${PREFIX}/share/model/ && \
    echo rm -rf ${DIR}; \
    else \
    echo "VMAF skipped."; \
    fi
...
COPY --from=ffmpeg /opt/ffmpeg/lib64/*.so.* /usr/lib/
